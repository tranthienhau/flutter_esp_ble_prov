...
class _MyAppState extends State<MyApp> {
  ...
  Future scanBleDevices() async {
    try {
      ...
      String errorMessage = 'Error scanning BLE devices: $e';
      if (e is PlatformException) {
        errorMessage = e.message ?? 'Unknown error occurred';
      }
      pushFeedback(errorMessage);
    }
  }
  ...
  Future scanWifiNetworks() async {
    try {
      ...
      String errorMessage = 'Error scanning WiFi networks: $e';
      if (e is PlatformException) {
        errorMessage = e.message ?? 'Unknown error occurred';
      }
      pushFeedback(errorMessage);
  ...
  Future provisionWifi() async {
    try {
      ...
      String errorMessage = 'Error provisioning WiFi: $e';
      if (e is PlatformException) {
        errorMessage = e.message ?? 'Unknown error occurred';
      }
      pushFeedback(errorMessage);
